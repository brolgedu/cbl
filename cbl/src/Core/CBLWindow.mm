...
void CBLWindow::Init(const WindowProps &props) {
    ...
    SetWindowTitleColor(mWindow, mData.Color);
...
void CBLWindow::SetWindowTitleColor(GLFWwindow *window, ImVec4& color) {
    ...
    wnd.backgroundColor = [NSColor colorWithSRGBRed:color.x green:color.y blue:color.z alpha:255];
}
